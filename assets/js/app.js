...
var _classie = require('./modules/classie');

var _classie2 = _interopRequireDefault(_classie);

var _uiSearch = require('./modules/uiSearch');
...
var _backTop = require('./modules/backTop');
...
(function ($, $wnd, $body, $doc) {
  ...
  $(function () {
    _nav2.default.init();
    _classie2.default.init();
    _uiSearch2.default.init();
    _masonry2.default.init();
    _stickyHeader2.default.init();
    _backTop2.default.init();
  });
})(jQuery, $(window), $('body'), $(document));

},{"./modules/backTop":2,"./modules/classie":3,"./modules/masonry":4,"./modules/nav":5,"./modules/sticky-header":6,"./modules/uiSearch":7}],2:[function(require,module,exports){
'use strict';
